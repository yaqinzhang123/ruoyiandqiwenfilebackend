 ...
 *
 * @Project : nginx
 * @Program Name : com.ruoyi.webgis.common.CommonFields
 * @Description :
 * @Author : 郭胜凯
...
public class CommonFields {
     ...
     *
     * @Project : nginx
     * @Program Name : com.ruoyi.webgis.common.SESSION_KEY
     * @Description :
     * @Author : 郭胜凯
     ...
     *
     * @Project : nginx
     * @Program Name : com.ruoyi.webgis.common.ERROR_CODE
     * @Description :
     * @Author : 郭胜凯
     ...
     *
     * @Project : nginx
     * @Program Name : com.ruoyi.webgis.common.PATH
     * @Description :
     * @Author : 郭胜凯
    ...
    public static final class PATH {
         ...
         * Nginx所在目录配置Key
         */
        public static String PATH_NGINX = "nginx.path";
     ...
     *
     * @Project : nginx
     * @Program Name : com.ruoyi.webgis.common.PROP
     * @Description :
     * @Author : 郭胜凯
    ...
    public static final class PROP {
         ...
         *
         * @Project : nginx
         * @Program Name : com.ruoyi.webgis.common.HTTP
         * @Description :
         * @Author : 郭胜凯
