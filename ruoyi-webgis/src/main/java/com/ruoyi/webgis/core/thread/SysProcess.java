package com.ruoyi.webgis.core.thread;

import com.ruoyi.webgis.core.thread.en.ProcessType;

/**
 * 系统进程封装类
 *
 * @Project : nginx
 * @Program Name : com.ruoyi.webgis.core.thread.SysProcess
 * @Description :
 * @Author : 郭胜凯
