...
import com.ruoyi.webgis.bean.NginxConfig;
 ...
 *
 * @Project : nginx-gui
 * @Program Name : com.ruoyi.webgis.controller.LisnerController.java
 * @Description :
 * @Author : 郭胜凯
    ...
    public void addServerLisner(String nameAndPort, NginxServer server, NgxConfig conf) {
        ...
        for (NgxEntry enty : servers) {
            ...
            if (nameAndPort.equals(nginxServer.getName() + ":" + nginxServer.getPort())) {
                ...
                String localhost = SysConfigConstant.configs.get("Service_Addr");
