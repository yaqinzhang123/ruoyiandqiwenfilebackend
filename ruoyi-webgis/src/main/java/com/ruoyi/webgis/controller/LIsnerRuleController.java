...
import com.ruoyi.webgis.bean.TableDate;
import com.ruoyi.webgis.bean.nginx.NginxProxySetHeader;
import com.ruoyi.webgis.bean.nginx.NginxLocation;
import com.ruoyi.webgis.bean.nginx.NginxUpstream;
...
/**
 * @Project : git
 * @Prackage Name : com.ruoyi.webgis.controller
 * @Description : 监听规则管理
 * @Author : 郭胜凯
...
//            conf.remove(http);
     ...
     *
     * @param location    新规则实体
     * @param oldLocation 所属监听域
     * @param oldRule     旧的规则路径
     * @param conf
     */
